    ...
    export default {
        ...
        methods: {
            ...
            onFileChange(e){
              ...
              data.append('appid', this.$store.getters.showQuery);
              this.editor.focus();
              ...
              xhr.onload=function () {
                if(xhr.status==200){
                  ...
                  self.editor.insertEmbed(self.editor.getSelection().index, 'image', xhr.response.data.path);
                }
              }
            },
            /*裁切上传成功 res根据上传接口值获取*/
            onUploadSuccess:function (res) {
              ...
              this.editor.insertEmbed(this.editor.getSelection().index, '121212', 'http://scrm.beats-digital.com/Ajax/Media/ShowImage?image='+res.data.url);
            },
            /*点击上传图片按钮*/
            imgClick() {
                if(this.canCrop){
