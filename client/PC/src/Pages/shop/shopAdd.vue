...
<div class>
    <div class="main">
        <div class="content">
            <h2 class="title" v-if="saveType=='添加'">礼品管理-添加</h2>
            <h2 class="title" v-if="saveType=='编辑'">礼品管理-编辑</h2>
            ...
            <div class="form">
                <div class="formLeft">
                    ...
                    <div class="formContent">
                        ...
                        <div class="input">
                            <el-input v-model="integral" type="number" placeholder="请输入内容"></el-input>
                        </div>
                    </div>

                    <!-- 礼品库存 -->
                    <div class="formContent">
                        <div class="name">礼品库存</div>
                        <div class="input">
                            <el-input v-model="stock" type="number" placeholder="请输入内容"></el-input>
                        </div>
                    </div>
                    ...
                    <div class="formContent">
                        ...
                        <div class="input">
                            <el-input v-model="sortIndex" type="number" placeholder="请输入内容"></el-input>
                        </div>
                    </div>
...
export default {
    ...
    methods: {
        save() {
            ...
            this.openFullScreen();
            this.giftvoucher_add(full_name, name, text, integral, stock, sort, cover, imgs);
        },
        giftvoucher_add(full_name, name, text, integral, stock, sort, cover, imgs) {
            var data = {};
            ...
            interfaceApi.giftvoucher_add(data, (res) => {
    ...
    created() {
        ...
        if (typeof this.index !== "undefined") {
            this.giftvoucher_deta(this.index);
        }
    },
    //生命周期 - 挂载完成（可以访问DOM元素）
    mounted() {},
